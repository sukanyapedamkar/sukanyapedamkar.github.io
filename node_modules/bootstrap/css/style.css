...
.leftSide .leftContent .social-tab ul li, .rightSide .rightContent .content .social-tab ul li {
  padding: 5px; }
  .leftSide .leftContent .social-tab ul li a, .rightSide .rightContent .content .social-tab ul li a {
    padding: 0.5em; }
    .leftSide .leftContent .social-tab ul li a:hover, .rightSide .rightContent .content .social-tab ul li a:hover {
      color: #f26522; }
    .leftSide .leftContent .social-tab ul li a i, .rightSide .rightContent .content .social-tab ul li a i {
      padding: 5px;
      transition: all 0.2s;
...
.loader {
  ...
  .loader .loaderContent {
    ...
    .loader .loaderContent h3 {
      ...
      border-bottom: none;
      animation: blink-caret .3s step-end infinite, fade-out-effect 4s forwards; }
...
.desktop .leftside.contract .leftContent {
  ...
  .desktop .leftside.contract .leftContent h2 {
    font-size: 1.2em; }
.desktop .rightSide #particle-slider {
  display: none; }
...
.mobile .leftSide, .tablet .leftSide {
  display: none; }
.mobile .close, .tablet .close {
  display: none; }
.mobile .navbar, .tablet .navbar {
  ...
  z-index: 1; }
  .mobile .navbar .navbar-nav, .tablet .navbar .navbar-nav {
    text-align: center; }
.mobile .rightSide, .tablet .rightSide {
  background: #ffffff;
  overflow-y: scroll;
  height: 100%; }
  .mobile .rightSide #particle-slider, .tablet .rightSide #particle-slider {
    padding: 1em;
    overflow: hidden;
    background: #000000;
    text-align: center;
    height: 100%; }
    .mobile .rightSide #particle-slider .draw, .tablet .rightSide #particle-slider .draw {
      width: 80%;
      margin: 20% auto;
      vertical-align: -webkit-baseline-middle;
      height: 80%; }
  .mobile .rightSide .bgImgWrap, .tablet .rightSide .bgImgWrap {
    display: none; }
  .mobile .rightSide .rightContent, .tablet .rightSide .rightContent {
    position: relative;
    left: 0; }
    .mobile .rightSide .rightContent .content .profileInfoWrap,
    .mobile .rightSide .rightContent .content .profileImg, .tablet .rightSide .rightContent .content .profileInfoWrap,
    .tablet .rightSide .rightContent .content .profileImg {
      margin-bottom: 15px; }
.mobile.landscape .mainBtn,
.mobile.landscape .social-tab, .tablet.landscape .mainBtn,
.tablet.landscape .social-tab {
  position: relative;
  bottom: auto; }
.mobile .hamburger, .tablet .hamburger {
  margin: 0 auto;
  -webkit-transition: 0.6s;
  -ms-transition: 0.6s;
  -moz-transition: 0.6s;
  -o-transition: 0.6s;
  transition: 0.6s; }
.mobile .footerWrap, .tablet .footerWrap {
  padding: 1em; }
